...
<header class="header">
	<div class="container">
		<nav class="navbar navbar-expand-md">
			<button class="navbar-toggler order-2" type="button" data-toggle="collapse" data-target="#navbar-login" id="button-toggle">
			...
			<div class="account order-3 navbar-collapse collapse" id="navbar-login">
